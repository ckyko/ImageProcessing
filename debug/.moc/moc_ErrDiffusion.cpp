...
const QMetaObject ErrDiffusion::staticMetaObject = {
    { &ImageFilter::staticMetaObject, qt_meta_stringdata_ErrDiffusion.data,
      qt_meta_data_ErrDiffusion,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ErrDiffusion::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ErrDiffusion.stringdata0))
        return static_cast<void*>(const_cast< ErrDiffusion*>(this));
